...
public class ExperienceData extends AbstractDAO<World.ExpLevel>
{
  ...
  public void load()
  {
    ...
    try
    {
      ...
      while(RS.next())
      {
        Main.world.addExpLevel(RS.getInt("lvl"),new World.ExpLevel(RS.getDouble("perso"),RS.getInt("metier"),RS.getInt("dinde"),RS.getInt("pvp"),RS.getLong("tourmenteurs"),RS.getLong("bandits"), RS.getDouble("expomega"), RS.getInt("lvlomega")));
      }
    }
