...
public class Constant
{
  ...
  public static final int ITEM_POS_DOFUS7 = 120;
  public static final int ITEM_POS_DOFUS8 = 121;
  public static final int ITEM_POS_DOFUS9 = 122;
  ...
  public static final int ITEM_POS_DOFUS_ULTIME_1 = 126;
  ...
  public static Stats getMountStats(int color, int lvl)
  {
    ...
    switch(color)
    {
      ...
      case 75:
        ...
        break;   //Sakoch�re
		case 91:
	        stats.addOneStat(STATS_ADD_DOMA, lvl/4);
		break;
		
		//Kramkram
		case 92:
		    stats.addOneStat(STATS_ADD_VITA, lvl*40000);
		    stats.addOneStat(STATS_ADD_FORC, lvl*10000);
		    stats.addOneStat(STATS_ADD_INTE, lvl*10000);
		    stats.addOneStat(STATS_ADD_AGIL, lvl*10000);
		    stats.addOneStat(STATS_ADD_CHAN, lvl*10000);	    
		break;
		
		//Boufx
		case 93:
		    stats.addOneStat(STATS_ADD_INTE, lvl*10);
		break;
		
		//Dragodinde a plume
		case 94:
		    stats.addOneStat(STATS_ADD_VITA, lvl*1);
		    stats.addOneStat(STATS_TRAPDOM, (int)(lvl/10));
		break;
		...
		//Balafreux
		case 97:
			stats.addOneStat(STATS_ADD_VITA, lvl*80000);
		    stats.addOneStat(STATS_ADD_FORC, lvl*20000);
		    stats.addOneStat(STATS_ADD_INTE, lvl*20000);
		    stats.addOneStat(STATS_ADD_AGIL, lvl*20000);
		    stats.addOneStat(STATS_ADD_CHAN, lvl*20000);
		break;
		
		//Kwaltess
		case 98:
		    stats.addOneStat(STATS_ADD_PA, lvl/100);
		    stats.addOneStat(STATS_REM_VITA, lvl*1);
		break;
  ...
  public static boolean isValidPlaceForItem(ObjectTemplate template, int place)
  {
    ...
    switch(template.getType())
    {
      ...
      case ITEM_TYPE_DOFUS:
        if(place==ITEM_POS_DOFUS1||place==ITEM_POS_DOFUS2||place==ITEM_POS_DOFUS3||place==ITEM_POS_DOFUS4||place==ITEM_POS_DOFUS5||place==ITEM_POS_DOFUS6|| place == ITEM_POS_DOFUS7 || place == ITEM_POS_DOFUS8
                || place == ITEM_POS_DOFUS8 || place == ITEM_POS_DOFUS9
                || place == ITEM_POS_DOFUS10 || place == ITEM_POS_DOFUS11
                || place == ITEM_POS_DOFUS12)
          return true;
        break;
        
      case ITEM_TYPE_DOFUS_ULTIME:
          if(place==ITEM_POS_DOFUS_ULTIME_1)
            return true;
          break;
