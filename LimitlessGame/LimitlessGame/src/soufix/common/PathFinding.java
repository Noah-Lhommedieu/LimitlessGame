...
private static Integer nSteps=new Integer(0);
  ...
  public static long newCaseAfterPush(Fight fight, GameCase CCase, GameCase TCase, long value)
  {
  ...
  public static long newCaseAfterPush(Fight fight, GameCase currentCell, GameCase targetCell, long a2, boolean piege)
  {
    GameMap map=fight.getMap();
 ...
 /* private static Fighter getFighterScythe(int CellID, char c, GameMap map)
  ...
  private static ArrayList<Integer> getLoSBotheringIDCases(GameMap map, int cellID1, int cellID2, boolean Combat)
  {
    ...
    while(getDistanceBetween(map,consideredCell1,consideredCell2)>2&&compteur<300)
    {
      ...
      { // si il ya une plus grande diff�rence pour la premi�re coordonn�e
        if(diffX>0)
          dir='f';
        else
          dir='b';
      ...
      { // si il y a une plus grand diff�rence pour la seconde
