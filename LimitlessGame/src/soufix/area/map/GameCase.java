...
public class GameCase
{
  ...
  public boolean canDoAction(int id)
  {
    ...
    switch(id)
    {
      ...
      case 124:
        switch(this.object.getId())
        {
          case 7529://Petits poissons de riviï¿½re
            return this.object.getState()==JobConstant.IOBJECT_STATE_FULL;
        }
        return false;
      //Pï¿½cher Pichon
      ...
      case 125:
        switch(this.object.getId())
        {
          case 7532://Poissons de riviï¿½re
            return this.object.getState()==JobConstant.IOBJECT_STATE_FULL;
        }
        return false;
      ...
      case 126:
        switch(this.object.getId())
        {
          case 7537://Gros poissons de riviï¿½re
            return this.object.getState()==JobConstant.IOBJECT_STATE_FULL;
        }
        return false;
      ...
      case 127:
        switch(this.object.getId())
        {
          case 7539://Poissons gï¿½ants de riviï¿½re
            return this.object.getState()==JobConstant.IOBJECT_STATE_FULL;
        }
        return false;
      ...
      case 131:
        switch(this.object.getId())
        {
          case 7540://Poissons gï¿½ants de mer
            return this.object.getState()==JobConstant.IOBJECT_STATE_FULL;
        }
        return false;
      //Boulanger
  ...
  public void  startAction(final Player player, GameAction GA)
  {
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(player,"Vous faites déjà quelque chose. Veuillez contacter un membre du personnel si le problème persiste.");
      return;
    }
    ...
    switch(actionID)
    {
      ...
      case 157: //Zaapis
        ...
        if(player.getCurMap().getSubArea().getArea().getId()==7&&(player.get_align()==1||player.get_align()==0||player.get_align()==3))//Ange, Neutre ou Sï¿½rianne
        {
          Zaapis=Constant.ZAAPI.get(Constant.ALIGNEMENT_BONTARIEN).split(",");
          if(player.get_align()==1)
            price=10;
        } else if(player.getCurMap().getSubArea().getArea().getId()==11&&(player.get_align()==2||player.get_align()==0||player.get_align()==3))//Dï¿½mons, Neutre ou Sï¿½rianne
        {
