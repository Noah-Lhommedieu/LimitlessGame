...
public class Stats
{
  ...
  public Stats(boolean addBases, Player perso)
  {
    ...
    if(!addBases)
      return;
    this.effects.put(Constant.STATS_ADD_PA, 12);
    this.effects.put(Constant.STATS_ADD_PM, 6);
    this.effects.put(Constant.STATS_ADD_PROS,perso.getClasse()==Constant.CLASS_ENUTROF ? 120 : 100);
    this.effects.put(Constant.STATS_ADD_PODS,20000);
    this.effects.put(Constant.STATS_ADD_SUM,perso.getClasse()==Constant.CLASS_OSAMODAS ? 25 : 15);
  ...
  public int addOneStat(int id, long l)
  {
    ...
    } else
    {
      ...
      if(newVal<=0)
      {
        ...
        this.effects.put(id,(int) newVal);
    }
