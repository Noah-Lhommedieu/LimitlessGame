...
public class World
{
  ...
  private static Map<Integer, ExpLevel> experiences=new HashMap<>();
  ...
  public double getPersoXpMin(int _lvl)
  {
...
public double getPersoXpMax(int _lvl)
  {
    if(_lvl>=getExpLevelSize())
  ...
  public static ObjectTemplate getObjTemplate(int id) {
  ...
  public double getGuildXpMax(int _lvl)
  {
    if(_lvl>=200)
      _lvl=199;
    if(_lvl<=1)
 ...
 // }
  ...
  public static class ExpLevel
  {
    ...
    public int mount;
    public int pvp;
    public double guilde;
    public long tourmenteurs;
    public long bandits;
    public double expomega;
    public int lvlomega;

    public ExpLevel(double f, int m, int d, int p, long t, long b, double e, int o)
    {
      perso=f;
      metier=m;
      this.mount=d;
      pvp=p;
      guilde=perso*10; //perso * 10
      tourmenteurs=t;
      bandits=b;
      expomega = e;
      lvlomega = o;
  ...
  private static class CompNivelMasMenos implements Comparator<Player> {
      public int compare(Player p1, Player p2) {
          return Double.valueOf(p2.getExp()).compareTo((p1.getExp()));
      }
  }
