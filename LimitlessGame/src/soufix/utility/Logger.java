...
public class Logger {
    ...
    /**
     *
     * @param filePath Chemin d'accès relatif ou absolue du fichier où écrire
     * les logs.
     */
     ...
     * seras plein ou à l'appel de la fonction "write()".
     *
     * @param toAdd Chaine de caractère à placer dans le buffer en vue d'une
     * écriture.
     */
    ...
    /**
     * Écrit le contenue du buffer par un appel à la fonction "write()" et ferme
