...
public void setTourplus() {
  ...
  {
    return (long) (this.pdvMax+getBuffValue(Constant.STATS_ADD_VITA));
  }
  ...
  public long getPdv()
  {
    return (long) (this.pdv+getBuffValue(Constant.STATS_ADD_VITA));
  }
  ...
  public void removePdv(Fighter caster, double dgt)
  {
    if(dgt>0)
      ...
      for(SpellEffect buff : fightBuffs)
      {
        ...
        switch(buff.getEffectID())
        {
          ...
          //case Constant.STATS_REM_PA2:
            ...
            this.setCurPa(this.fight,(int) (this.getCurPa(fight)+buff.getValue()));
            break;
          ...
          //case Constant.STATS_REM_PM2:
            ...
            this.setCurPm(this.fight,(int) (this.getCurPm(fight)+buff.getValue()));
            break;
          case Constant.STATS_REM_PM2:
  ...
  public String getGmPacket(char c, boolean withGm)
  {
    ...
    switch(this.type)
    {
      ...
      case 5://Perco
        ...
        str.append("1;");
        str.append("2;4;");
        str.append((int)Math.floor(G.getLvl()/4)).append(";").append((int)Math.floor(G.getLvl()/4)).append(";").append((int)Math.floor(G.getLvl()/4)).append(";").append((int)Math.floor(G.getLvl()/4)).append(";").append((int)Math.floor(G.getLvl()/4)).append(";").append((int)Math.floor(G.getLvl()/4)).append(";").append((int)Math.floor(G.getLvl()/4)).append(";");//R�sistances
        str.append(this.team);
        break;
      case 7://Prisme
        str.append("-2;");
